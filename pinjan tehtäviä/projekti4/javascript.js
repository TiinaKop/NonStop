...
function uusiTehtava() {
  var lista = document.createElement("li"); //Luodaan li elementti
  ...
  lista.appendChild(teksti); // liitetään teksti li elementtiin
  if (kayttajanTehtava === '') {  // käyttäjä painaa liitä, muttei ole tekstiä
    alert("Kirjoita tehtävä");
  } else {
    document.getElementById("tehtavat").appendChild(lista); // liitetään teksti tehtavat elementtiin
  }
  ...
  lista.appendChild(span); // liitetään span li elementtiin
...
// Poistaa tehtävän, kun painaa X painiketta
